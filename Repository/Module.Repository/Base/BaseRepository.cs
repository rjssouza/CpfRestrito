...
namespace Module.Repository.Base
{
    ...
    public abstract class BaseRepository : IBaseRepository
    {
        ...
        {
            return ExecuteFuncWithLog(sql, parameters, () => _dbService.DbConnection.Execute(sql, parameters));
        }
        ...
        {
            return ExecuteFuncWithLog(sql, parameters, () => _dbService.DbConnection.ExecuteScalar<T>(sql, parameters, transaction: _dbService.Transaction));
        }
        ...
        protected virtual List<T> Select<T>(string sql, DynamicParameters parameters = null)
        {
            ...
            {
                var resultadoEnumerado = _dbService.DbConnection.Query<T>(sql, parameters, transaction: _dbService.Transaction);
        ...
        {
            return ExecuteFuncWithLog(sql, parameters, () => _dbService.DbConnection.QueryFirstOrDefault<T>(sql, parameters, transaction: _dbService.Transaction));
        }
